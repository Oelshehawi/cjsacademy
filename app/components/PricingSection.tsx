...
const PricingSection = () => {
  ...
  const opacityDesktop = useTransform(scrollYProgress, [0.3, 0.5], [0, 1]);
  const opacityMobile = useTransform(scrollYProgress, [0, 0.2], [0, 1]);
